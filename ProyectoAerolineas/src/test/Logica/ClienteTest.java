...
class ClienteTest {
    ...
    void constructorYGettersDeberianRetornarDatosCorrectos() {
        ...
        assertEquals(TipoDoc.CI, cliente.getTipoDocumento());
    ...
    void crearClienteConNicknameNullDeberiaLanzarExcepcion() {
        assertThrows(IllegalArgumentException.class, () ->
                new Cliente(null, "Nombre", "Apellido", "email@mail.com", LocalDate.now(), "Uruguaya", TipoDoc.CI, "1234", "pass", "img.png"));
    }

    @Test
    void crearClienteConNombreNullDeberiaLanzarExcepcion() {
        assertThrows(IllegalArgumentException.class, () ->
                new Cliente("nickname", null, "Apellido", "email@mail.com", LocalDate.now(), "Uruguaya", TipoDoc.CI, "1234", "pass", "img.png"));
    }

    @Test
    void crearClienteConApellidoNullDeberiaLanzarExcepcion() {
        assertThrows(IllegalArgumentException.class, () ->
                new Cliente("nickname", "Nombre", null, "email@mail.com", LocalDate.now(), "Uruguaya", TipoDoc.CI, "1234", "pass", "img.png"));
    }

    @Test
    void crearClienteConEmailNullDeberiaLanzarExcepcion() {
        assertThrows(IllegalArgumentException.class, () ->
                new Cliente("nickname", "Nombre", "Apellido", null, LocalDate.now(), "Uruguaya", TipoDoc.CI, "1234", "pass", "img.png"));
    }

    @Test
    void crearClienteConFechaNacNullDeberiaLanzarExcepcion() {
        assertThrows(IllegalArgumentException.class, () ->
                new Cliente("nickname", "Nombre", "Apellido", "email@mail.com", null, "Uruguaya", TipoDoc.CI, "1234", "pass", "img.png"));
    }

    @Test
    void crearClienteConNacionalidadNullDeberiaLanzarExcepcion() {
        assertThrows(IllegalArgumentException.class, () ->
                new Cliente("nickname", "Nombre", "Apellido", "email@mail.com", LocalDate.now(), null, TipoDoc.CI, "1234", "pass", "img.png"));
    }
    ...
    void crearClienteConNumDocNullDeberiaLanzarExcepcion() {
        assertThrows(IllegalArgumentException.class, () ->
                new Cliente("nickname", "Nombre", "Apellido", "email@mail.com", LocalDate.now(), "Uruguaya", TipoDoc.CI, null, "pass", "img.png"));
    }

    @Test
    void crearClienteConContraseniaNullDeberiaLanzarExcepcion() {
        assertThrows(IllegalArgumentException.class, () ->
                new Cliente("nickname", "Nombre", "Apellido", "email@mail.com", LocalDate.now(), "Uruguaya", TipoDoc.CI, "1234", null, "img.png"));
    }
