...
class ManejadorPaqueteTest {
    ...
    void compraPaquete_SuccessAndClientMissing() throws Exception {
        ...
        Cliente clienteObj = new Cliente("nick1", "Nom", "Ape", "c@mail", LocalDate.now(), "Pais", TipoDoc.CI, "123", "pwd", null);
        when(mcMock.obtenerClienteReal("nick1")).thenReturn(clienteObj);
        setManagerInstance(ManejadorCliente.class, mcMock);

        DtCliente dt = new DtCliente("nick1", "Nom", "c@mail", null, "Ape", LocalDate.now(), "Pais", TipoDoc.CI, "123", LocalDate.now(), List.of(), List.of());
        ...
        DtCliente dt2 = new DtCliente("nope", "X", "x@mail", null, "A", LocalDate.now(), "P", TipoDoc.CI, "999", LocalDate.now(), List.of(), List.of());
    ...
    void getPaquetes_getPaquetesDisp_obtenerDtItemsPaquete() {
        ...
        Cliente clienteObj = new Cliente("nick2", "N", "A", "c2@mail", LocalDate.now(), "P", TipoDoc.CI, "111", "pwd", null);
