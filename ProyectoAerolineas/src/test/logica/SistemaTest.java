...
class SistemaTest {
    ...
    void altaCliente_SuccessAndDuplicate() {
        ...
        when(mcMock.obtenerCliente(anyString())).thenReturn(null);
        Sistema s = new Sistema();
        s.altaCliente("nick1", "Nombre", "Apellido", "a@mail", LocalDate.now(), "Pais", TipoDoc.CEDULAIDENTIDAD, "123", "pass", null);
        ...
        assertThrows(IllegalArgumentException.class, () -> new Sistema().altaCliente("nick1","n","a","e@mail",LocalDate.now(),"P",TipoDoc.CEDULAIDENTIDAD,"123","p","img"));
    }
    ...
    void deprecatedAltaMethods_ShouldThrowUnsupported() {
        ...
        assertThrows(UnsupportedOperationException.class, () -> s.altaCliente("n","N","A","e@mail", LocalDate.now(), "P", TipoDoc.CEDULAIDENTIDAD, "123"));
